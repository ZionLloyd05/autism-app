            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span user-id="<?php echo $session->user_id; ?>" class="userInfo">, <?php echo $gd_lastname; ?></span>
                    </a>
                </div>
                <!-- End Logo -->
                    ...
                    <div class="card">
                            <div class="card-body p-b-0">
                                    ...
                                    <ul class="nav nav-tabs customtab" role="tablist">
                                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home2" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Doctors</span></a> </li>
    ...
    <script>
        $(document).ready(function(){
            ...
            function fetch_users(){
                ...
                $.ajax({
                    url: "ajaxfiles/fetch_doctor.php",
                    method: "POST",
                    data: {
                        'userid':userid
                    },
