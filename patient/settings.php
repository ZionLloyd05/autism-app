                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="date" id="dob" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Blood Group</label>
                                <div class="col-md-12">
                                    <input type="text" id="blgroup" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Genotype</label>
                                <div class="col-md-12">
                                    <input type="text" id="genotype" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Guardian Firstname</label>
                                <div class="col-md-12">
                                    <input type="text" id="gfname" class="form-control form-control-line" name="example-email" id="example-email">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Guardian Lastname</label>
                                <div class="col-md-12">
                                    <input type="text" id="glname" class="form-control form-control-line" name="example-email" id="example-email">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <input type="hidden" id="p_id" user-id=<?php echo $session->user_id; ?>>
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    $("#fname").val(data.pfirstname);
                    $("#lname").val(data.plastname);
                    $("#dob").val(data.dob);
                    $("#blgroup").val(data.bloodgroup);
                    $("#genotype").val(data.genotype);
                    $("#gfname").val(data.gfirstname);
                    $("#glname").val(data.glastname);
